...
(script dormant e7_cov_inf0_main
	...
	(ai_teleport_to_starting_location_if_outside_bsp e7_cov_hunters0)
	...
	(ai_teleport_to_starting_location_if_outside_bsp e7_cov_inf0)
)
...
(script dormant e6_cov_hunters0_from_e5_main
	; Wait until they've moved on from the previous encounter
	(sleep_until
		(and
			(<= (ai_living_count e5_pro_inf0) 0)
			(<= (ai_living_count e5_pro_inf1) 0)
			(<= (ai_living_count e5_pro_inf2) 0)
			;(<= (ai_living_count e5_pro_inf3) 0)
		)
	)
	(ai_migrate e5_cov_hunters0 e6_cov_hunters0_from_e5)
	(ai_teleport_to_starting_location_if_outside_bsp e6_cov_hunters0_from_e5)
)
...
(script dormant e6_cov_hunters0_main
	...
	(if 
		(or
			(>= (ai_living_count e5_cov_hunters0) 2)
			(>= (ai_living_count e6_cov_hunters0_from_e5) 2)
		)
		(sleep_forever)
	)
...
(script dormant e6_cov_inf0_main
	...
	(ai_migrate e6_cov_hunters0_from_e5 e6_cov_hunters0)
...
(script dormant e6_main
	(sleep_until (volume_test_objects tv_e5_to_e6 (players)) 15)
	(wake e6_cov_hunters0_from_e5_main)
	...
	(sleep_forever e6_cov_hunters0_from_e5_main)
