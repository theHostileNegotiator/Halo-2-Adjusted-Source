	...
	(sleep_until
		(begin	
			(cond
				((passenger_seat_test)	(begin
										(if debug (print "player is passenger"))
										(ai_set_orders covenant_infantry cov_follow_factory_veh_exit)
										(ai_set_orders covenant_vehicles cov_follow_factory_veh_exit)
									)
				)
				(true (ai_set_orders covenant cov_follow_factory_veh_exit))
			)
			(and
				(and
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_cov_def_spectre/spectre) "spectre_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location veh_int_hog_ab/hog) "warthog_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location veh_int_scorpion/scorpion) "scorpion_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location fact_ent_flood_scorpion/starting_locations_0) "scorpion_d" (players)) FALSE)
				)
				(volume_test_objects tv_fact_ent_follow (players))
	...
	(sleep_until
		(begin	
			(cond
				((passenger_seat_test)	(begin
										(if debug (print "player is passenger"))
										(ai_set_orders covenant_infantry cov_ext_b_veh_exit)
										(ai_set_orders covenant_vehicles cov_ext_b_veh_exit)
									)
				)
				(true (ai_set_orders covenant cov_ext_b_veh_exit))
			)
			(and
				(and
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_cov_spectre/spectre) "spectre_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_fact_scorpion/scorpion) "scorpion_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_fact_warthog/warthog) "warthog_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_warthog/warthog) "warthog_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_warthog_gauss/warthog) "warthog_d" (players)) FALSE)
					(= (vehicle_test_seat_list (ai_vehicle_get_from_starting_location qz_ext_b_ent_scorpion/starting_locations_0) "scorpion_d" (players)) FALSE)
				)
				(volume_test_objects tv_ext_b_exit_door (players))
